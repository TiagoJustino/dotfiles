This is a fork of [skwp/dotfiles](https://github.com/skwp/dotfiles).
...
#### sh -c "\`curl -fsSL https://raw.githubusercontent.com/tiagojustino/dotfiles/master/install.sh \`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/tiagojustino/dotfiles/master/install.sh`" -s ask
```
